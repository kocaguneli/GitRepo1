...
\name{{ \LARGE Ekrem Kocaguneli }\\[12pt]}
\address{{ 1325 Stewartstown Road, Apt. G6, Morgantown, WV 26505 $\bullet$ (304)-685-9487 $\bullet$ ekrem@kocaguneli.com $\bullet$ www.kocaguneli.com }\\[12pt]} % the \\[12pt] adds a blank line after name
...
%\item Bursa Private Nilüfer Science High School, (2000 - 2003), Bursa/Turkey, 5.00/5.00
\end{list}
...
%\item University Entrance Exam, 81st place out of 1.7 Million Students in Turkey, (2003)
\end{list}
...
%\begin{list}{\labelitemi}{\leftmargin=-5.5em}
%\item[] \textit{Professional references provided upon request.}
%\end{list} 

%\section{Hobbies}
%\begin{list}{\labelitemi}{\leftmargin=0.5em}
%\item Playing trumpet, playing guitar, doing yoga, photography, formula-1.
%\end{list} 
